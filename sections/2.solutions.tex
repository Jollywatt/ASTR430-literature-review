...
\note{There are a variety of implementations of the Peccei--Quinn mechanism.}
...
Consequently, the Nöther \note{Noether?} current associated to the $\UPQ$ symmetry, $\ts J_\text{PQ}$, is not conserved:
\begin{align}
	\ts\dd\star\ts J_\text{PQ} &= \xi \angbr{\tsbm F\wedge\tsbm F}
&	&\text{i.e.,}
&	\partial_\mu J_\text{PQ}^\mu &= \frac\xi4\angbrAd{\bm F_{μν}, \bm F_{\rho\sigma}}\epsilon^{μν\rho\sigma}
,\end{align}
