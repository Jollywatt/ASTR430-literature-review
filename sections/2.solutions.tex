...
\subsubsection{Original Peccei--Quinn Axion}

The original Peccei--Quinn model of the axion, which was proposed in \cite{PecceiQuinn_1977} alongside the Peccei--Quinn mechanism, implemented the $\UPQ$ symmetry by supposing that the standard model possessed two Higgs fields $h_1$ and $h_2$ which couple differently to up and down quarks.
