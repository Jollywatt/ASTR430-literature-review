...
Similar to the massless quark solution, this would render the $θ$-parameter unphysical thereby trivially solving the strong \CP\ problem.
...
What Peccei and Quinn showed was that even if the $\UPQ$ symmetry is not exact, then $\bar θ$ would be dynamically driven to zero, provided $\UPQ$ was also spontaneously broken.
...
This particle---the axion---is the \emph{pseudo-Nambu--Goldstone boson} of the spontaneously broken $\UPQ$ symmetry.
