...
Because $\UPQ$ is chiral, it is broken by the chiral anomaly (see §\,\ref{sec:fermions-and-the-chiral-anomaly}).
Consequently, the Noether current $\ts J_\text{PQ}$ associated to the $\UPQ$ symmetry is not conserved, instead obeying
\begin{align}
...
,\end{align}
where $ξ$ is a model-dependent parameter.
