...
.\end{align}
Since $\eval{\fdv*{\bm ψ}{α}}_0 = i \bm ψ$, the conserved Nöther current density associated to this symmetry is
\begin{align}
	\ts J_V %&= \pdv{\ts{\cal L}_\text{Dirac}}{\ts\nabla ψ} \, \fdv{\bm ψ}{α}
	&= \bar{\bm ψ}\,\bm γ_μ \bm ψ \star \ts\dd x^μ
,&	\text{i.e.,}\quad
	j_V^{\,μ} &= \bar{\bm ψ}\,\bm γ^μ \bm ψ
	\quad\text{where}\quad
	% \star\ts J = j^μ \,δ_{μν} \ts\dd x^ν
	\star\ts J_V = \ts j_V
,\end{align}
