...
% The standard model enjoys the global $\U(1)$ symmetry by $\bm ψ \mapsto e^{iα}\bm ψ$.
% These transformations are known as vector fermion rotations.
...
The Dirac Lagrangian classically exhibits another global Abelian symmetry, given by \emph{axial fermion rotations} $\U(1)_A$
\begin{align}
...
,\end{align}
is conserved classically, but not in the QFT \note{which QFT? The Dirac Lagrangian? Or just QCD, etc?}.
