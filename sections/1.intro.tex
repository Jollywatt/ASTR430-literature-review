...
% \subsection{The Yang--Mills Lagrangian and the Topological Term}
\subsection{The Yang--Mills Lagrangian and the \texorpdfstring{$\theta$-Term}{θ-Term}}

\note{Needs intro}


\urgent{Note: I misunderstood the literature and the following is not accurate.}
...
\footnotetext{
	The Bianchi identity $\ts\dd_A\tsbm F = 0$ is true independent of the Lagrangian.
}
